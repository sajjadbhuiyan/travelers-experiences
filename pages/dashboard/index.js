...
function DashBoard() {
    ...
    return (
        <div className="">
            <div>
                <div className="w-64 absolute sm:relative bg-gray-800 shadow xl:h-screen md:h-full flex-col justify-between hidden sm:flex">
                    <div className="px-8">
                        ...
                        <ul className="mt-12">
                            ...
                            <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                                <Link href='dashboard/pendingBlog'>
                                    <a>
                                        <div className="flex items-center">
                                            ...
                                            <span className="text-sm  ml-2">Pending Blog</span>
                                        </div>
                                    </a>
                                </Link>
                            </li>
                            ...
                            <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center">
                                <div className="flex items-center">
                                    ...
                                    <Link href='/'>
                                    <a>
                                        <span className="text-sm  ml-2">Go to Home</span>
                                    </a>
                                    </Link>
                                </div>
                            </li>
