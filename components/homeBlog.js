...
function HomeBlog(){
    return(
        ...
        <center><h1  className="text-indigo-700 text-4xl lg:text-6xl font-black mb-8">BLOG POSTS</h1></center>
         <div className="max-w-screen-2xl place-items-center sm:grid-cols-1 mx-auto gap-8 grid lg:grid-cols-4">
             {/* ====card1==== */}
             <div className=" w-80 h-auto bg-white drop-shadow-md">
                 ...
                 <div className="p-2 grid gap-y-6">
                     <div className="grid grid-cols-6">
                         ...
                         <div className="col-span-4">
                             ...
                             <p className="text-sm">Tiger was little but Danger</p>
                         </div>
                     </div>
                     {/* ======icon wiht info==== */}
